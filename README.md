...
1. :warning: Open the App.svelte file and replace **YOUR_MAPTILER_API_KEY_HERE** with your actual [MapTiler API key](https://cloud.maptiler.com/account/keys/).
...
- [svelte-maps](https://github.com/ONSvisual/svelte-maps) – Reusable map components for Svelte projects
